...
FAST-CSS metamodel is defined in a way where nodes align with those generated by Tree-Sitter.

## Installation  

To load FAST-CSS in Pharo, execute the following in a Moose image:  

```smalltalk  
Metacello new  
  baseline: 'FASTCSS';  
  repository: 'github://Evref-BL/FAST-CSS:main';  
  load.
```  
